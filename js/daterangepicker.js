    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            if (this.element.is('input') && !this.singleDatePicker) {
                this.element.attr('value',this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
                this.element.attr({'start': this.startDate.format(this.format),'end': this.endDate.format(this.format)});
                findSource();
